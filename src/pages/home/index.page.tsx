...
import { BackGround, BigTitle, Button, Container,  Content,  FormLogo,  Logo, SquareStyle, SubTitle, Title } from "./styles";
  ...
  <Container>
    ...
    <Content>
     <BackGround src={'/backGround.svg'} width={1000} height={2000}></BackGround>
      ...
      /> 
      <FormLogo>
      <Logo src={'/logoNight.svg'}/> <Logo src={'/logoDeuFarra.svg'}/>
      </FormLogo>
